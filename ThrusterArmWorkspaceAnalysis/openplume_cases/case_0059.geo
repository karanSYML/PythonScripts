// ==================================================================
// OpenPlume Geometry — Case 0059
// Status   : MARGINAL  |  Max erosion: 12.852 µm  (51.4% of Ag thickness)
//
// Thruster pos    : [5.00000, 0.00000, -1.55000] m
// Thrust direction: [-0.96741, 0.00000, 0.25323]
// Plume direction : [0.96741, -0.00000, -0.25323]
...
//
// Mesh with: gmsh case_0059.geo -3 -o case_0059.msh
// ==================================================================
...
Point(200) = {5.000000, 0.000000, -1.550000, lc_thruster};

// Plume-direction arrow tip (2 m along plume, visual reference)
// Direction: [0.96741, -0.00000, -0.25323]
Point(201) = {6.934811, 0.000000, -2.056465, lc_thruster};
...
// Worst-case erosion panel point (off-axis 35.4°, d=8.61 m)
//   Max erosion = 12.852 µm at this panel point
