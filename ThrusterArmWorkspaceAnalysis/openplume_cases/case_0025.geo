// ==================================================================
// OpenPlume Geometry — Case 0025
// Status   : MARGINAL  |  Max erosion: 13.326 µm  (53.3% of Ag thickness)
//
// Thruster pos    : [3.50000, 0.00000, -1.55000] m
// Thrust direction: [-0.93665, 0.00000, 0.35026]
// Plume direction : [0.93665, -0.00000, -0.35026]
...
//
// Mesh with: gmsh case_0025.geo -3 -o case_0025.msh
// ==================================================================
...
// ────────────────────────────────────────────────────────────────
// Solar panel +X  span=12.00 m, width=2.50 m, thickness=25 mm, track=0.0°
// ────────────────────────────────────────────────────────────────
// Panel before tracking rotation (hinge at X=1.2500, Z=1.5000)
Box(3) = {1.25000, -1.25000, 1.48750,  12.00000, 2.50000, 0.02500};

// ────────────────────────────────────────────────────────────────
// Solar panel −X  (symmetric, same tracking rotation)
// ────────────────────────────────────────────────────────────────
// Panel before tracking rotation (hinge at X=-1.2500, Z=1.5000)
Box(4) = {-13.25000, -1.25000, 1.48750,  12.00000, 2.50000, 0.02500};

// ────────────────────────────────────────────────────────────────
// Computational domain — sphere  R = 20.00 m
// ────────────────────────────────────────────────────────────────
// Encloses full panel span (13.2 m) plus 6 m margin
...
Point(200) = {3.500000, 0.000000, -1.550000, lc_thruster};

// Plume-direction arrow tip (2 m along plume, visual reference)
// Direction: [0.93665, -0.00000, -0.35026]
Point(201) = {5.373304, 0.000000, -2.250521, lc_thruster};
...
// Worst-case erosion panel point (off-axis 38.2°, d=10.03 m)
//   Max erosion = 13.326 µm at this panel point
