...
// Status   : CAUTION  |  Max erosion: 3.396 µm  (13.6% of Ag thickness)
//
// Thruster pos    : [2.50000, 0.00000, -1.55000] m
// Thrust direction: [-0.88593, 0.00000, 0.46381]
// Plume direction : [0.88593, -0.00000, -0.46381]
...
Point(200) = {2.500000, 0.000000, -1.550000, lc_thruster};

// Plume-direction arrow tip (2 m along plume, visual reference)
// Direction: [0.88593, -0.00000, -0.46381]
Point(201) = {4.271867, 0.000000, -2.477625, lc_thruster};
...
// Worst-case erosion panel point (off-axis 43.8°, d=10.98 m)
//   Max erosion = 3.396 µm at this panel point
