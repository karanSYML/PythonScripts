// ==================================================================
// OpenPlume Geometry — Case 0048
// Status   : MARGINAL  |  Max erosion: 15.769 µm  (63.1% of Ag thickness)
//
// Thruster pos    : [4.50000, 0.00000, -1.55000] m
// Thrust direction: [-0.96021, 0.00000, 0.27928]
// Plume direction : [0.96021, -0.00000, -0.27928]
...
//
// Mesh with: gmsh case_0048.geo -3 -o case_0048.msh
// ==================================================================
...
Point(200) = {4.500000, 0.000000, -1.550000, lc_thruster};

// Plume-direction arrow tip (2 m along plume, visual reference)
// Direction: [0.96021, -0.00000, -0.27928]
Point(201) = {6.420421, 0.000000, -2.108554, lc_thruster};
...
// Worst-case erosion panel point (off-axis 35.9°, d=9.08 m)
//   Max erosion = 15.769 µm at this panel point
