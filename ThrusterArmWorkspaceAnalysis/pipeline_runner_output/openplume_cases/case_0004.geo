// ==================================================================
// OpenPlume Geometry — Case 0004
// Status   : MARGINAL  |  Max erosion: 7.708 µm  (77.1% of Ag thickness)
//
// Thruster pos    : [2.62000, 0.00000, -2.35000] m
// Thrust direction: [-0.82293, 0.00000, 0.56815]
// Plume direction : [0.82293, -0.00000, -0.56815]
// Stack COG       : [0.00000, 0.00000, -0.54116] m
// Panel tracking  : 0.0°
...
//
// Mesh with: gmsh case_0004.geo -3 -o case_0004.msh
// ==================================================================
...
// Direction: [0.82293, -0.00000, -0.56815]
Point(201) = {4.265856, 0.000000, -3.486291, lc_thruster};
Line(200) = {200, 201};  // plume-direction arrow

// Stack centre-of-gravity at mission start
Point(202) = {0.000000, 0.000000, -0.541165, lc_structure};

// Worst-case erosion panel point (off-axis 49.6°, d=14.87 m)
//   Max erosion = 7.708 µm at this panel point
