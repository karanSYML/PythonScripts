// ==================================================================
// OpenPlume Geometry — Case 0001
// Status   : MARGINAL  |  Max erosion: 5.953 µm  (59.5% of Ag thickness)
//
// Thruster pos    : [2.62000, 0.00000, -2.35000] m
// Thrust direction: [-0.83520, 0.00000, 0.54995]
// Plume direction : [0.83520, -0.00000, -0.54995]
// Stack COG       : [0.00000, 0.00000, -0.62481] m
// Panel tracking  : 0.0°
...
//
// Mesh with: gmsh case_0001.geo -3 -o case_0001.msh
// ==================================================================
...
// Direction: [0.83520, -0.00000, -0.54995]
Point(201) = {4.290392, 0.000000, -3.449904, lc_thruster};
Line(200) = {200, 201};  // plume-direction arrow

// Stack centre-of-gravity at mission start
Point(202) = {0.000000, 0.000000, -0.624807, lc_structure};

// Worst-case erosion panel point (off-axis 48.4°, d=14.87 m)
//   Max erosion = 5.953 µm at this panel point
