// ==================================================================
// OpenPlume Geometry — Case 0000
// Status   : MARGINAL  |  Max erosion: 8.350 µm  (83.5% of Ag thickness)
//
// Thruster pos    : [2.62000, 0.00000, -2.35000] m
// Thrust direction: [-0.85185, 0.00000, 0.52378]
// Plume direction : [0.85185, -0.00000, -0.52378]
// Stack COG       : [0.00000, 0.00000, -0.73903] m
// Panel tracking  : 0.0°
// Servicer origin : [0.00000, 0.00000, -2.75000] m  (Z-, LAR docked)
//
// Coordinate system: X=velocity, Y=orbit-normal, Z=anti-earth
// Client bus centred at origin. Servicer below (Z−) via LAR.
//
// Mesh with: gmsh case_0000.geo -3 -o case_0000.msh
// ==================================================================
...
lc_farfield  = 1.860;  // m — outer domain boundary
...
// ────────────────────────────────────────────────────────────────
// Servicer bus  0.900 × 1.520 × 0.800 m  (Z− docking via LAR)
// ────────────────────────────────────────────────────────────────
Box(2) = {-0.45000, -0.76000, -3.15000,  0.90000, 1.52000, 0.80000};

// ────────────────────────────────────────────────────────────────
// Solar panel +X  span=16.00 m, width=2.50 m, thickness=25 mm, track=0.0°
// ────────────────────────────────────────────────────────────────
// Panel before tracking rotation (hinge at X=1.2500, Z=1.5000)
Box(3) = {1.25000, -1.25000, 1.48750,  16.00000, 2.50000, 0.02500};

// ────────────────────────────────────────────────────────────────
// Solar panel −X  (symmetric, same tracking rotation)
// ────────────────────────────────────────────────────────────────
// Panel before tracking rotation (hinge at X=-1.2500, Z=1.5000)
Box(4) = {-17.25000, -1.25000, 1.48750,  16.00000, 2.50000, 0.02500};

// ────────────────────────────────────────────────────────────────
// Computational domain — sphere  R = 23.25 m
// ────────────────────────────────────────────────────────────────
// Encloses full panel span (17.2 m) plus 6 m margin
...
Sphere(100) = {0, 0, 0, 23.25000};

// ────────────────────────────────────────────────────────────────
// Thruster source geometry
// ────────────────────────────────────────────────────────────────
// Thruster exit centre — OpenPlume plume source
Point(200) = {2.620000, 0.000000, -2.350000, lc_thruster};

// Plume-direction arrow tip (2 m along plume, visual reference)
// Direction: [0.85185, -0.00000, -0.52378]
Point(201) = {4.323705, 0.000000, -3.397563, lc_thruster};
Line(200) = {200, 201};  // plume-direction arrow

// Stack centre-of-gravity at mission start
Point(202) = {0.000000, 0.000000, -0.739031, lc_structure};

// Worst-case erosion panel point (off-axis 46.6°, d=14.87 m)
//   Max erosion = 8.350 µm at this panel point
...
Field[2].DistMax  = 13.950;    // m  outer radius (coarse)
